...
public class MaarExampleCPIMSupplierURLCheck {
    ...
    //@Test
    @ParameterizedTest
    @CsvFileSource(resources = "/MaarExampleSupplierURL.csv")
    /*
    @CsvSource(
            {
                    "AWNFH7FGH5"
    ...
    */
    public void selenium_01_MaarExample_SupplierURLCheck(String CaseID)
    {
        System.out.printf("========================================\n");
        ...
        try {
            // Test
            //driver.get("http://lmtest.test.com/search/" + CaseID);
            // Production
            driver.get("https://lm.test.com/search/" + CaseID);

            wait = new WebDriverWait(driver, 4);
            driver.manage().timeouts().implicitlyWait(4, TimeUnit.SECONDS);
            driver.manage().timeouts().pageLoadTimeout(4, TimeUnit.SECONDS);

            if( driver.findElements(By.xpath("//div[contains(text(),'Supplier URL')]//following::input[@class='k-textbox ng-untouched ng-pristine ng-valid']")).size() < 1)
            {
                System.out.println("TEST :: " + ANSI_YELLOW + "NA - NO SUPPLIER URL" + ANSI_RESET);
